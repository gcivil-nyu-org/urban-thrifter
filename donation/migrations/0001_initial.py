    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resource_category', models.CharField(choices=[('FOOD', 'Food'), ('MEDICAL/ PPE', 'Medical/ PPE'), ('CLOTHING/ COVERS', 'Clothing/ Covers'), ('ELECTRONICS', 'Electronics'), ('OTHERS', 'Others')], max_length=100)),
